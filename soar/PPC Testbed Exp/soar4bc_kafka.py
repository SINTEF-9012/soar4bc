...
controller_uri = "http://127.0.0.1:8080/firewall/rules/000042798acc3b40"
...
def kafka_playbook_consumer():
    ...
    consumer = KafkaConsumer(
        ...
        sasl_plain_password='user1password', 
    ...
    try:
        for message in consumer:
            try:
                ...
                if attacker_ip:
                    # Process the action based on the playbook (same logic as previous /update_playbook endpoint)
                    ...
                    logging.error("Attacker IP not found")
...
def action_automator(attacker_ip, dpid="000042798acc3b40"):
