...
class Config:
    ...
    NEO4J_PASSWORD: str = 'sin***-*****'
    
    # External APIs
    WAZUH_URI: str = "https://wazuh.trsc.net:9200/wazuh-alerts*/_search"
    WAZUH_AUTH: str = 'Basic **********='
    SDN_CONTROLLER_URI: str = "http://127.0.0.1:8080/firewall/rules/000042798acc3b40"
    ...
    def execute(self, attacker_ip: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.dashboard.update_attacker_status(attacker_ip, "Blocked")
                return {"status": "success", "message": "Charging profile overwritten"}
            else:
